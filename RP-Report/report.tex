...
\lstinputlisting[language=python, caption=Get Malicious URLs From Virus Total]{./files/12-GetMaliciousURLsFromIPsUsingVirusTotal.py}

 
\lstinputlisting[language=python, caption=Add URL's to PostgreSQL Database]{./files/13-AddURLsToDB.py}

 
\lstinputlisting[language=python, caption=Submit URL's for Scan to VirusTota]{./files/14-SubmitURLsForScanUsingVirusTotal.py}

 
\lstinputlisting[language=python, caption=Get URL Scan results from VirusTotal]{./files/15-GetURLScanResults.py}
...
\lstinputlisting[language=python, caption=Virus Total API Request Sample]{./files/response.txt}
